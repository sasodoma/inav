...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH4, PB1, TIM_USE_MC_MOTOR |  TIM_USE_FW_SERVO,0,0), //S2 DMA2_ST3  T8CH2
    DEF_TIM(TIM3, CH1, PB4, TIM_USE_MC_MOTOR |  TIM_USE_FW_SERVO,0,0), //S3 DMA2_ST4  T8CH3
    DEF_TIM(TIM2, CH2, PB3, TIM_USE_MC_MOTOR |  TIM_USE_FW_SERVO,0,0), //S5 DMA2_ST1  T1CH1
    DEF_TIM(TIM8, CH4, PC9, TIM_USE_MC_MOTOR |  TIM_USE_FW_MOTOR,0,0), //S4 DMA2_ST7  T8CH4
    DEF_TIM(TIM8, CH3, PC8, TIM_USE_MC_MOTOR |  TIM_USE_FW_MOTOR,0,0), //S6 DMA2_ST6  T1CH2

    DEF_TIM(TIM1, CH1, PA8,TIM_USE_LED,0,0), //2812 STRIP DMA1_ST5
};
